...
<body background="<%= request.getContextPath() %>/img/back.jpg">
	...
	<div class="body">
		<div class="mypage">
			<div>
				<c:set value = "${marketing}" var = "marketing2" />
				<h4> &nbsp;&nbsp;&nbsp; <i class="fa-solid fa-house-user"> &nbsp; </i> ${marketing2.marCompany}</h4>
			</div>
			<center>
				<table class="jmh_table">
					<tr>
						<td rowspan='8' class="jmh_saleimg"><img class="jmh_imgsize"
							src="${marketing2.marImg}" alt="My Image"></td>
						</td>
					</tr>
					<tr>
						<td colspan='2'><h1 class="jmh_title2">${marketing2.marProduct}</h1></b></td>
					</tr>
					<tr class="jmh_info2">
						<td colspan = '2'>${marketing2.marDetail}</td>
					</tr>
				
					<tr>
						<td class="jmh_buyprice">금액</td>
						<td class="jmh_buyprice"> ${marketing2.marPrice }원</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="jmh_buyprice"> <a id="total_amount">${marketing2.marPrice}</a>원</td>
...
var basic_amount = parseInt('${marketing2.marPrice }');
